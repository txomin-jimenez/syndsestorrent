...
namespace tests\modules\animeIndexOrg\host;

use modules\animeIndexOrg\host\SynoFileHostingAnimeIndex;

/**
 * Generated by PHPUnit_SkeletonGenerator 1.2.1 on 2014-06-08 at 02:27:12.
 */
class SynoFileHostingAnimeIndexTest extends \utils\BaseHostTest
{
    protected function setUp()
    {
        parent::setObject(
            new SynoFileHostingAnimeIndex(
                "http://tracker.anime-index.org/index.php?page=torrent-details&"
                . "id=379e17f0dae4b50b6347c707c6e0461755274fe6"
            )
        );
    }

    /**
     * @covers modules\animeIndexOrg\host\SynoFileHostingAnimeIndex::GetDownloadInfo
     */
